...
import jwt from "jsonwebtoken"; // need this for authenticity and authorization

// JSON (JavaScript Object Notation) is a standard, text-based format for storing and transmitting data objects
const app = express();
const JWT_KEY = "Kaustubh";

app.use(express.json());
// on body parser which takes req as a json obj , middleware
app.use(cors());
// Cross-origin resource sharing (CORS) for browser security 


app.post("/register", async (req, res) => { //for user authentication 
  try {
...
app.post("/add-product", verifyToken, async (req, res) => { //for product authentication 
  try {
